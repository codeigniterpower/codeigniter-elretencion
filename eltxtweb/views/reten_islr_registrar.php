...
echo div_open('class="contain-form mx-auto px-3 py-3"');
	echo form_open('por/definir/metodo/controller', array('method'=> 'post', 'class' => ''));
		...
		echo div_open('class="contain d-flex"');
			...
			echo div_close();
			echo div_open('class="form-group contain-group  justify-content-between d-flex"');
				echo form_label('Codigo de Retención:', $islrInvoiceDate);
				echo br();
		...
		echo div_open('class="contain d-flex"');
			...
			echo div_close();
			echo div_open('class="form-group contain-group  justify-content-between d-flex"');
				echo form_label('Islr Retenido:', $isrlDetained);
				echo br();
		...
		echo div_open('class="contain d-flex"');
			...
			echo div_close();
			echo div_open('class="form-group contain-group  justify-content-between d-flex"');
				echo form_label('Impuestos retenido acumulado:', $islrAccumulatedWithholdingTax);
				echo br();
