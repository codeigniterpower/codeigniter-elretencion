...
CREATE TABLE IF NOT EXISTS `reten_facturas` (
  ...
  `mon_factura` DECIMAL(80,2) NOT NULL DEFAULT 0.0 COMMENT 'cantida pagada en fatura o total compras',
  `mon_factura_moneda` VARCHAR(40) NOT NULL DEFAULT 'VES' COMMENT 'codigo iso moneda enque esta la factura',
  `mon_objeto_retencion` DECIMAL(80,2) NULL COMMENT 'monto de operacion',
  `num_porcentaje_tasa` SMALLINT NULL DEFAULT 0 COMMENT 'tasa en porcentage retenido en dicho caso',
  `mon_retenido_o_iva` DECIMAL(80,2) NULL DEFAULT 0.0,
  `mon_objeto_retencion_acumulada` DECIMAL(80,2) NULL DEFAULT 0.0 COMMENT 'cantidad de objeto de retencion acumulada',
  `mon_retenido_o_iva_acumulado` DECIMAL(80,2) NULL DEFAULT 0.0,
