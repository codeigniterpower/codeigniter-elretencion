...
echo div_open('class="contain-form mx-auto px-3 py-3"');
	echo form_open('por/definir/metodo/controller', array('method'=> 'post', 'class' => ''));
		...
		echo div_open('class="contain d-flex"');
			...
			echo div_close();
			echo div_open('class="form-group contain-group  justify-content-between d-flex"');
				echo form_label('Registro de información fiscal del sujeto de retenido (R.I.F):', $islrRegistroDeSujetoDeInformaciónFiscal);
				echo br();
				echo form_input(array('name'=>$islrRegistroDeSujetoDeInformaciónFiscal, 'id'=>$islrRegistroDeSujetoDeInformaciónFiscal, 'type'=>'text', 'class'=>'w-100', 'placeholder'=>'', 'required') );
			echo div_close();
		echo div_close();
		echo br();
		echo div_open('class="contain d-flex"');
			...
			echo div_close();
			echo div_open('class="form-group   contain-group  justify-content-between d-flex"');
				echo form_label('Numero de factura', $isrlAgenteFiscal);
				echo br();
				echo form_input(array('name'=>$isrlAgenteFiscal, 'id'=>$isrlAgenteFiscal, 'type'=>'text', 'class'=>'w-100', 'required') );
			echo div_close();
		echo div_close();
		echo br();
		echo div_open('class="contain d-flex"');
			...
			echo div_close();
			echo div_open('class="form-group contain-group  justify-content-between d-flex"');
				echo form_label('Codigo de Retención:', $islrFechaDeFactura);
				echo br();
		...
		echo div_open('class="contain d-flex"');
			echo div_open('class="form-group me-3  contain-group  justify-content-between d-flex"');
				echo form_label('Cant Pagada;', $isrlCantidadPagar);
				echo br();
				echo form_input(array('name'=>$isrlCantidadPagar, 'id'=>$isrlCantidadPagar, 'type'=>'text', 'class'=>'w-100', 'required') );
			echo div_close();
		echo div_open('class="form-group contain-group  justify-content-between d-flex"');
		...
		echo div_open('class="contain d-flex"');
			...
			echo div_close();
			echo div_open('class="form-group contain-group  justify-content-between d-flex"');
				echo form_label('Islr Retenido:', $isrlDetenido);
				echo br();
		...
		echo div_open('class="contain d-flex"');
			...
			echo div_close();
			echo div_open('class="form-group contain-group  justify-content-between d-flex"');
				echo form_label('Impuestos retenido acumulado:', $islrImpuestoRetenidoAcumulado);
				echo br();
